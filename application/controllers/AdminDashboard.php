...
class AdminDashboard extends CI_Controller {
	...
	{
	$flag=1;
	$data['student_data']  = $this->Home_M->Get_AluminiList($flag);
	...
	$data['student_data']  = $this->Home_M->Get_EnquiryList($flag=1,$qualification='',$from_date='',$to_date='');
	//echo"<pre>"; print_r($data['student_data']); die;
	...
	$data['student_data']  = $this->Home_M->Get_EnquiryList($flag,$qualification,$from_date,$to_date);
