...
<div class="container mt-5">
	<div class="row">
        ...
        <div class="col-md-8">
        	<div class="card">
        		<h4 class="card-header">Transaction <label for="Success" class="badge text-success">Success</label></h4>
        		<div class="card-body">
        			<?php
		                echo "<p>Thank You. Your is ". $status .".</br>";
		                echo "Your Transaction ID for this transaction is ".$txnid."</br>";
		                echo "Total Fees " . $amount . " Rs.</p>";
		            ?>
        		</div>
        	</div>
