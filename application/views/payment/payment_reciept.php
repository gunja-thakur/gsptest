...
<h5 class="text-success">Transaction <?php echo $status;?> </h5>
...
<button onclick="window.print()" class="btn btn-sm btn-outline-success pull_right pr m-1">Print</button>
<a href="<?php echo base_url();?>" class="btn btn-sm btn-outline-success pull_right lgn m-1">Go to Login</a>
