          ...
          <div class="flex_header">
            ...
            <div class="logo_side">
              <div class="logo_side_img">
                <a href="<?php echo base_url();?>Placement/Home">
            ...
            <h2 class="site_title md_d_none">Training and Placement Cell </h2>

            <!-- MAIN NAVIGATION -->
            <div class="header-nav nav-dark navbar-collapse">
              <h2 class="site_title sm_d_none">Training and Placement Cell </h2>
              <ul class="nav navbar-nav ">
                <li> <a href="<?php echo base_url();?>"> Overview </a> </li>
                <!-- <li>
                  <a href="javascript:void(0);" class="drop_icon">Connect</a>
                  <ul class="sub-menu">
                    <li><a href="<?php echo base_url();?>Placement/Alumni_Directory">Alumni Directory </a></li>
                  </ul>
                </li> -->
                <li><a href="#" class="drop_icon">Training </a>				<ul class="sub-menu">
                <li><a href="<?php echo base_url();?>Placement/OJT">On Job Training (OJT) </a></li>				</ul>				</li>
                <li><a href="#" class="drop_icon">Placement </a>				<ul class="sub-menu">
                <li><a href="<?php echo base_url();?>Placement/Why_recruit_from_GSP"> Why recruit from GSP</a></li>
                <li><a href="<?php echo base_url();?>Placement/Recruitment_process">Recruitment Process </a></li>
                <li><a href="<?php echo base_url();?>Placement/Placement_partners">Placement Partners </a></li>
                <li><a href="<?php echo base_url();?>Placement/Campus_drive">Campus Drive </a></li>
                <li><a href="<?php echo base_url();?>Placement/Vacancy">Vacancy </a></li>

                </ul>				</li>

                <li> <a href="<?php echo base_url();?>Recruiters"> Registration </a> </li>
                <li> <a href="<?php echo base_url();?>Placement/Contact_Us"> Contact Us </a> </li>
              ...
              <ul>
                <li data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Login Portal"><a href="#" id="dropdownLoginLink" role="button" data-bs-toggle="dropdown" aria-expanded="false" class=" dropdown-toggle"> <i class="bi bi-person-check"></i> Login </a>
                  <div class="dropdown-menu text-start" aria-labelledby="dropdownLoginLink">
                    <a class="d-block" title="Alumni Portal" href="<?php echo base_url()?>Login">TPO </a>
                    <a class="d-block" title="Student Login" href="<?php echo base_url()?>Recruiters/Login">Recruiter </a>
                  </div>
                </li>
