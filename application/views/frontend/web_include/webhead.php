<meta charset="utf-8" />
  ...
  <title>Alumni Portal - Global Skill Park Bhopal - Madhya Pradesh</title>
  <link rel="shortcut icon" type="image/icon" href="<?php echo base_url();?>assets/website/images/favicon.png" />
  <!-- =============== Css Edition =============== -->
  <link rel="preload" href="<?php echo base_url(); ?>assets/website/css/style.css" as="style" media="print" />
