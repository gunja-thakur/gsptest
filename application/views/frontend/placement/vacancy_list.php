...
<div class="table-responsive">
                        <table class="table table-bordered table-sm table-striped" id="datatablesSimple1">
                          ...
                          <tbody>
                            <?php $i = 1;
                            foreach ($vacancy_data as $sd) {
                              extract($sd); ?>
                              <tr>
                                <td><?= $i ?></td>
                                <td><?= ucwords($job_title) ?></td>
                                <td><?= $total_vacancy ?></td>
                                <td width="25%"><?php echo mb_substr($sd['job_description'], 0, 80);?></td>
                                <td><?= $job_location ?></td>
                                ...
                                <td width="15%"><a href="<?php echo base_url(); ?>assets/job/<?php echo $sd['job_attachment']; ?>" target="_blank" class="readmore"> View File</a></td>
