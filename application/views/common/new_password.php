<?php foreach($user_data as $rd) { extract($rd); } ?>
<!DOCTYPE html>
<html lang="hi">
		...
		<div class="container">
			<div class="login_form_view">
				...
				<form action="" method="post" id="changeform">
					<div>
					<input type="text" class="form-control" id="user_id" name="user_id" value="<?php echo $rd['user_id'];?>">
		...
		$(document).ready(function() {
			...
			$("#change").click(function() {
				...
				$.ajax({
					...
					url: "<?= base_url() ?>Password/NewPassword_Save",
					method: "post",
