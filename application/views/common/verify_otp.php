	...
	<section class="login_section">
		<div class="container">
			<div class="login_form_view">
				...
				<form action="<?php echo base_url(); ?>Password/NewPassword" method="post">
				<div>
					<input type="hidden" class="form-control" id="user_id" name="user_id" value="<?php echo $this->session->userdata('reset_user_id');?>">
