...
<div class="row">
						...
						<div class="card">
                            ...
                            <div class="col-xl-6 col-md-6 mb-4">
                                ...
                                <div class="numbercount font_600">Total Registration   :
...
<td colspan="5"> 10 </td> 
                        ...
                        <div class="card mb-4">
                            ...
                            <?php  if($this->session->userdata['user_role'] == 1 OR $this->session->userdata['user_role'] == 2 OR $this->session->userdata['user_role'] == 3   OR $this->session->userdata['user_role'] == 7 OR $this->session->userdata['user_role'] == 6) { ?>
