                      ...
                      <div class="row">
                        ...
                        <div class="col-md-3 col-sm-6 mb-3">
                          <div class="form_div">
                            ...
                            <input type="number" class="form-control" id="enrollment_no" name="enrollment_no" value="<?php echo $sd['enrollment_no'];?>"  aria-describedby="" readonly>
                          </div>
                        </div>
                        <div class="col-md-3 col-sm-6 mb-3">
                          <div class="form_div">
                        ...
                        <div class="col-md-3 col-sm-6 mb-3">
                          <div class="form_div">
                            ...
                            <input type="number" class="form-control" id="mobile" name="mobile" value="<?php echo $sd['mobile'];?>" aria-describedby="">
                          </div>
                        </div>
                        ...
                        <div class="col-md-3 col-sm-6 mb-3">
                          <div class="form_div">
                            ...
                            <input type="email" class="form-control" id="email" name="email" value="<?php echo $sd['email'];?>" aria-describedby="">
                          </div>
                        </div>
                        <div class="col-md-3 col-sm-6 mb-3">
                          <div class="form_div">
                            <label for="father_name" class="form-label">Father Name</label>
                            <input type="text" class="form-control" id="father_name" name="father_name" value="<?php echo $sd['father_name'];?>" aria-describedby="">
                          </div>
                        </div>
                        <div class="col-md-3 col-sm-6 mb-3">
                          <div class="form_div">
