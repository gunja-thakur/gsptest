...
<?php if (!empty($alumnicounter_data)) { ?>
  <div class="row">
    ...
    <!-- <div class="col-md-6 col-lg-6">
      <aside class="profile-nav alt">
        <section class="card ">
        <canvas class="m-2 p-1" id="myBarChart"></canvas>
        </section>
      </aside>
    </div> -->
          ...
          <table class="table">
            <tbody>
              <tr>
                ...
                <td> <span class="num_bg num_bg_c4 ViewRc" data-id=""  id="<?php echo $batch."@".$passing_year ;?>"> <?php echo $total_alumni; ?> </span> </td>
              </tr>
              <tr>
                <th scope="col">Verified</th>
                <td><span class="num_bg num_bg_c1 ViewRc" data-id="1" id="<?php echo $batch."@".$passing_year ;?>"> <?php echo $Totle_VerfiedAlumni; ?> </span> </td>
              </tr>
              <tr>
                <th scope="col">Pending</th>
                <td><span class="num_bg number_span ViewRc" data-id="2" id="<?php echo $batch."@".$passing_year ;?>"> <?php echo $Totle_PendingAlumni; ?> </span> </td>
              </tr>

              <tr>
                <th scope="col">Profile Updated</th>
                <td><span class="num_bg num_bg_c3 ViewRc" data-id="3" id="<?php echo $batch."@".$passing_year ;?>"> <?php echo $Total_ProfileUpdated; ?> </span> </td>
              </tr>
              <tr>
                <th scope="col">Notable </th>
                <td><span class="num_bg num_bg_c2 ViewRc" data-id="4" id="<?php echo $batch."@".$passing_year ;?>"> <?php echo $Totle_NotableAlumni; ?> </span> </td>
              </tr>
            </tbody>
          </table>
        </div>
        ...
        donut: {
          ...
          labels: {
            ...
            total: {
              show: !0,
              fontSize: "16px",
              label: "T0000000000000000000otal Value",
              color: "#9599ad",
              fontWeight: 400,
              formatter: function(e) {
