...
!(function (t, e) {
        ...
        O = (function (t) {
            ...
            function n(t) {
                ...
                return (
                    ...
                    i.attachEvents(),
                    i.trigger("ready"),
                    !1 !== i.option("centerOnStart") && i.panTo({ x: 0, y: 0, scale: i.option("baseScale"), friction: 0 }),
                    i
                );
            }
            return (
                s(n, [
                    ...
                    },
                    {
                        ...
                        value: function () {
                            (this.container = { width: 0, height: 0 }),
                                ...
                                (this.content = { origHeight: 0, origWidth: 0, width: 0, height: 0, x: 0, y: 0, scale: 1 }),
                                    ...
                                    (t.updateTimer = setTimeout(function () {
                                        ...
                                        if (e.width || e.height) {
                                            var i = t.option("observe"),
                                                n = !1;
                                            i.includes("w") && Math.abs(e.width - t.container.width) > 1 && (n = !0),
                                                i.includes("h") && Math.abs(e.height - t.container.height) > 1 && (n = !0),
                                                n && (t.endAnimation(), t.updateMetrics(), t.panTo({ x: t.content.x, y: t.content.y, scale: t.option("baseScale"), friction: 0 })),
                                                (t.updateTimer = null);
                                    ...
                                    if ("pointerdown" === t.state)
                                        if (0 != t.trigger("touchMove", o)) {
                                            if (!(i.length < 2 && t.transform.scale === t.option("baseScale") && 1 == t.option("panOnlyZoomed")) && (!(i.length > 1) || (t.option("zoom") && !1 !== t.option("pinchToZoom")))) {
                                                ...
                                                t.setDragResistance(), (t.transform = { x: t.dragPosition.x, y: t.dragPosition.y, scale: t.dragPosition.scale }), t.startAnimation();
                                            }
                                        } else o.preventDefault();
                                },
                                end: function (e, o) {
                                    if ("pointerdown" === t.state)
                                        if (((t._dragOffset = i({}, t.dragOffset)), n.currentPointers.length)) t.resetDragPosition();
                                        else if (
                                            ((t.state = "decel"),
                    ...
                    },
                    {
                        ...
                        value: function (t) {
                            ...
                            Object.assign(o.style, { width: "", height: "", maxWidth: "", maxHeight: "" }), s && Object.assign(a.style, { width: "", height: "" });
                            ...
                            if (((this.viewport.width -= parseFloat(m.paddingLeft) + parseFloat(m.paddingRight)), (this.viewport.height -= parseFloat(m.paddingTop) + parseFloat(m.paddingBottom)), h)) {
                                if (Math.abs(r - v.width) > 0.1 || Math.abs(l - v.height) > 0.1) {
                            ...
                            if (
                                (s && (Object.assign(a.style, { width: "".concat(u, "px"), height: "".concat(f, "px") }), (this.viewport = i(i({}, this.viewport), {}, { width: u, height: f }))),
                            ...
                            (this.content = i(i({}, this.content), {}, { origWidth: r, origHeight: l, fitWidth: u, fitHeight: f, width: u, height: f, scale: 1, isZoomable: h })),
                    ...
                    },
                    {
                        ...
                        value: function () {
                            ...
                            (this.friction = r),
                                ...
                                r
                                    ? ((this.state = "panning"),
                                      (this.velocity = { x: (1 / this.friction - 1) * (i - this.content.x), y: (1 / this.friction - 1) * (o - this.content.y), scale: (1 / this.friction - 1) * (a - this.content.scale) }),
                                      this.startAnimation())
                                    : this.endAnimation();
                        },
                    },
                    ...
                    },
                    {
                        ...
                        value: function () {
                            ...
                            t &&
                                this.option("touch") &&
                                (this.content.width <= this.content.fitWidth && this.transform.scale <= this.option("baseScale") && 1 == this.option("panOnlyZoomed") ? this.$viewport.classList.remove(t) : this.$viewport.classList.add(t));
                        },
                    },
                    {
                        key: "detachEvents",
    ...
    (O.version = "4.0.0-beta.0"), (O.Plugins = {});
    var z = function (t, e) {
            var i = 0;
            return function () {
                ...
                s(n, [
                    ...
                    },
                    {
                        ...
                        value: function () {
                            ...
                            ((this.$viewport = this.option("viewport") || this.$container.querySelector("." + i.viewport)), this.$viewport) ||
                                ((this.$viewport = document.createElement("div")), this.$viewport.classList.add(i.viewport), (t = this.$viewport).append.apply(t, g(this.$container.childNodes)), this.$container.appendChild(this.$viewport));
                            ((this.$track = this.option("track") || this.$container.querySelector("." + i.track)), this.$track) ||
                                ((this.$track = document.createElement("div")), this.$track.classList.add(i.track), (e = this.$track).append.apply(e, g(this.$viewport.childNodes)), this.$viewport.appendChild(this.$track));
                        },
                    },
                    {
                        key: "initSlides",
                        value: function () {
                            var t = this;
                            (this.slides = []),
                                this.$viewport.querySelectorAll("." + this.option("classNames.slide")).forEach(function (e) {
                                    var i = { $el: e, isDom: !0 };
                    ...
                    },
                    {
                        ...
                        value: function (t) {
                            if (!t) {
                                var e,
                                    i = this.slides[0];
                                if ((((t = document.createElement("div")).dataset.isTestEl = 1), (t.style.visibility = "hidden"), t.classList.add(this.option("classNames.slide")), i.customClass))
                        ...
                        value: function () {
                            this.Panzoom &&
                                ...
                                this.pages.length > 1 && this.option("infiniteX", this.option("infinite"))
                                    ...
                                    : (this.Panzoom.boundX = { from: -1 * this.pages[this.pages.length - 1].left, to: -1 * this.pages[0].left }),
                    ...
                    },
                    {
                        ...
                        value: function (t) {
                            ...
                            if (!e && this.pages.length > 1 && t.dragOffset.time < 350 && Math.abs(t.dragOffset.y) < 1 && Math.abs(t.dragOffset.x) > 5) this[t.dragOffset.x < 0 ? "slideNext" : "slidePrev"]();
                            else if (e) {
                ...
                s(t, [
                    {
                        ...
                        value: function () {
                            this.getSlides().length < this.fancybox.option("Thumbs.minSlideCount")
                                ? (this.state = "disabled")
                                : !0 === this.fancybox.option("Thumbs.autoStart") && this.fancybox.Carousel.Panzoom.content.height >= this.fancybox.option("Thumbs.minScreenHeight") && this.initLayout();
                        },
                    },
                    {
                        key: "onClosing",
                    ...
                    },
                    {
                        ...
                        value: function () {
                            return "visible" === this.state
                                ? (this.Carousel.Panzoom.detachEvents(), (this.$container.style.display = "none"), void (this.state = "hidden"))
                                : "hidden" === this.state
                                ? ((this.$container.style.display = ""), this.Carousel.Panzoom.attachEvents(), void (this.state = "visible"))
                            ...
                            if (!e || "string" == typeof e) {
                                ...
                                i ||
                                    ...
                                    ("html5video" !== i && "video" !== i) ||
                                        ((t.video = x({}, this.fancybox.option("Html.video"), t.video)), t.width && t.height ? (t.ratio = parseFloat(t.width) / parseFloat(t.height)) : (t.ratio = t.ratio || t.video.ratio));
                            }
                        },
                    },
                    {
                            ...
                            if ("video" === t.type && t.$iframe && t.$iframe.contentWindow) {
                                !(function e() {
                                    if ("done" === t.state && t.$iframe.contentWindow) {
                                        ...
                                        "youtube" === t.vendor && ((i = { event: "listening", id: t.$iframe.getAttribute("id") }), t.$iframe.contentWindow.postMessage(JSON.stringify(i), "*")), (t.poller = setTimeout(e, 250));
                                    }
                                })();
                            }
                        },
                ...
                },
                {
                    ...
                    value: function (t) {
                        ...
                        t.Panzoom ||
                            ((t.Panzoom = new O(
                                t.$el,
                                x(!0, this.fancybox.option("Image.Panzoom", {}), { viewport: t.$wrap, content: t.$image, textSelection: !0, touch: this.fancybox.option("Image.touch"), panOnlyZoomed: !0, click: !1, wheel: !1 })
                            )),
                    ...
                    value: function (t) {
                        if ("image" === t.type) {
                            var e = t.Panzoom,
                                ...
                                n = t.$el.classList;
                            if (e && "toggleZoom" === i) n[e && 1 === e.content.scale && e.option("maxScale") - e.content.scale > 0.01 ? "add" : "remove"](this.fancybox.option("Image.canZoomInClass"));
    ...
    var q = function () {
        ...
        V = {
            ...
            activate: function (t) {
                (V.pageXOffset = window.pageXOffset),
                    (V.pageYOffset = window.pageYOffset),
        ...
        Z = {
            items: {
                ...
                fullscreen: {
                    ...
                    click: function (t) {
                        t.preventDefault(), V.element() ? V.deactivate() : V.activate(this.fancybox.$container);
                    },
                },
                slideshow: {
                    type: "button",
                ...
                thumbs: {
                    ...
                    html:
                        '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" tabindex="-1"><circle cx="4" cy="4" r="1" /><circle cx="12" cy="4" r="1" transform="rotate(90 12 4)"/><circle cx="20" cy="4" r="1" transform="rotate(90 20 4)"/><circle cx="4" cy="12" r="1" transform="rotate(90 4 12)"/><circle cx="12" cy="12" r="1" transform="rotate(90 12 12)"/><circle cx="20" cy="12" r="1" transform="rotate(90 20 12)"/><circle cx="4" cy="20" r="1" transform="rotate(90 4 20)"/><circle cx="12" cy="20" r="1" transform="rotate(90 12 20)"/><circle cx="20" cy="20" r="1" transform="rotate(90 20 20)"/></svg>',
                    click: function (t) {
                        t.stopPropagation();
            ...
            return (
                s(t, [
                    ...
                    },
                    {
                        key: "onReady",
                        value: function () {
                            "init" === this.state && (this.build(), this.update(), (this.Slideshow = new U(this.fancybox)), this.fancybox.option("slideshow.autoStart") && !this.fancybox.Carousel.prevPage && this.Slideshow.activate());
                        },
                    },
                    {
                        key: "onFsChange",
                        value: function () {
                            window.scrollTo(V.pageXOffset, V.pageYOffset);
                        },
                    },
                    {
                        key: "onSettle",
                        ...
                        value: function () {
                            ...
                            try {
                                for (n.s(); !(t = n.n()).done; ) {
                                    var o = t.value;
                                    i
                                        ? (o.removeAttribute("disabled"), o.setAttribute("href", i), o.setAttribute("download", i), o.setAttribute("target", "_blank"))
                                        : (o.setAttribute("disabled", ""), o.removeAttribute("href"), o.removeAttribute("download"));
                                }
                            } catch (t) {
                                n.e(t);
                            } finally {
                            ...
                            var h,
                                d = y(this.fancybox.$container.querySelectorAll("[data-fancybox-index]"));
                            try {
                                for (d.s(); !(h = d.n()).done; ) {
                            ...
                            var u,
                                f = y(this.fancybox.$container.querySelectorAll("[data-fancybox-count]"));
                            try {
                                for (f.s(); !(u = f.n()).done; ) {
    ...
    G.defaults = Z;
    var K = { ScrollLock: B, Thumbs: H, Html: j, Image: X, Hash: Y, Toolbar: G },
        J = {
            startIndex: 0,
            preload: 1,
            infinite: !0,
        ...
        tt = (function (t) {
            ...
            function i(t) {
                ...
                return (
                    o(this, i),
                    ((n = e.call(this, x(!0, {}, J, a))).state = "init"),
                    n.setItems(t),
                    n.bindHandlers(),
                ...
                s(
                    ...
                    [
                        ...
                        },
                        {
                            ...
                            value: function () {
                                ...
                                e && (this.$root.insertAdjacentHTML("beforeend", this.localize(e)), (this.$container = this.$root.querySelector(".fancybox__container"))),
                                    ...
                                    Object.entries({ class: "fancybox__container", role: "dialog", "aria-modal": "true", "aria-hidden": "true", "aria-label": this.localize("{{MODAL}}") }).forEach(function (e) {
                                        var i;
                                    ...
                                    this.id || ((this.id = this.options.id || ++Q), this.$container.setAttribute("id", "fancybox-" + this.id));
                                var i,
                        ...
                        },
                        {
                            key: "onClick",
                            value: function (t) {
                                if (!t.defaultPrevented && !t.target.closest(".fancybox__content") && !window.getSelection().toString().length && !1 !== this.trigger("click", t))
                        ...
                        },
                        {
                            ...
                            value: function (t, e) {
                                ...
                                return (
                                    ...
                                    ("none" !== i.style.display && "none" !== window.getComputedStyle(i).getPropertyValue("display")) || (i.style.display = "flex"),
                        ...
                        },
                        {
                            ...
                            value: function () {
                                ...
                                if ((this.Carousel.destroy(), this.detachPlugins(), (this.Carousel = null), (this.options = {}), (this.events = {}), this.$container.remove(), (this.$container = this.$backdrop = this.$carousel = null), t))
                                    if (this.preventScrollSupported) t.focus({ preventScroll: !0 });
                                    else {
    ...
    (tt.version = "4.0.0-beta.0"), (tt.defaults = J), (tt.openers = new Map()), (tt.Plugins = K), tt.bind("[data-fancybox]"), (t.Carousel = N), (t.Fancybox = tt), (t.Panzoom = O);
});
